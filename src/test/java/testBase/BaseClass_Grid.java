...
import org.testng.annotations.Parameters;
	...
	public class BaseClass_Grid {
		...
		//only in this class pratik has mentioned this under method
		private WebDriver driver;   //for webdriver
		private Properties p;      // for property file which present inside config.properties
		...
		//make here changes for duplication public-->default
		 String randomString() //this method is generating random returning same.
		{
